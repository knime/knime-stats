...
/**
 * Snapshot test for {@link TwoSampleTTestNodeParameters}.
 */
@SuppressWarnings("restriction")
final class TwoSampleTTestNodeParametersTest extends DefaultNodeSettingsSnapshotTest {

    TwoSampleTTestNodeParametersTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(TwoSampleTTestNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static TwoSampleTTestNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(TwoSampleTTestNodeParameters.class).getParent().resolve("node_settings")
                .resolve("TwoSampleTTestNodeParameters.xml");

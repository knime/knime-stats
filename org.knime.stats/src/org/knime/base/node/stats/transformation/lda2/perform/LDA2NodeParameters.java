...
final class LDA2NodeParameters implements NodeParameters {
    ...
    @Widget(title = "Target dimensions", description = """
            ...
            """)
    @NumberInputWidget(minValidation = IsPositiveInteger.class)
    ...
    static final class IsPositiveInteger extends MinValidation {
    ...
    static final class InputColumnsChoicesProvider implements ColumnChoicesProvider {

 ...
 */
final class RankCorrelationCompute2NodeView extends NodeView<RankCorrelationCompute2NodeModel> {
     ...
     */
    public RankCorrelationCompute2NodeView(final RankCorrelationCompute2NodeModel model) {
        super(model);

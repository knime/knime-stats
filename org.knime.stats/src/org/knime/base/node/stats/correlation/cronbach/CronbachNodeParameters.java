...
/**
 * Node parameters for Cronbach Alpha.
 *
...
final class CronbachNodeParameters implements NodeParameters {
    ...
    @Persistor(CronbachColumnFilterPersistor.class)
    @TypedStringFilterWidgetInternal(hideTypeFilter = true)
    ColumnFilter m_columnFilter = new ColumnFilter();

    static final class CronbachColumnFilterPersistor extends LegacyColumnFilterPersistor {
        CronbachColumnFilterPersistor() {
            super(CronbachNodeModel.CFGKEY_INCLUDE_LIST);
        }
    }
}

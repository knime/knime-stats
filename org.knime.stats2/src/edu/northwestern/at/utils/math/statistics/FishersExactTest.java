...
public class FishersExactTest {
     ...
     *
     * @return double vector with three entries. [0] = two-sided Fisher's exact test. [1] = left-tail Fisher's exact
     *         test. [2] = right-tail Fisher's exact test.
     */
    public static double[] fishersExactTest(final int n11, final int n12, final int n21, final int n22) {
     ...
     */
    protected static double logCombination(final int n, final int k) {
     ...
     */
    protected static double hypergeometricProbability(final int x, final int n1d, final int n2d, final int nd1,
        final int nd2) {
        int n3 = nd1 - x;
        int ndd = nd1 + nd2;

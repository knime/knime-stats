...
class LDAComputeNodeDialog extends NodeDialogPane {
    ...
    /**
     * Change listener for the dimension spinner.
     *
     */
    private class SpinnerCL implements ChangeListener {
        ...
        public void stateChanged(final ChangeEvent e) {
            ...
            // update warnings only if the Spinner was invalid before to avoid a little overhead
    ...
    protected LDAComputeNodeDialog(final SettingsModelString classColModel,
        final SettingsModelColumnFilter2 usedColsModel, final SettingsModelInteger dimensionModel) {
        m_classColModel = classColModel;
        m_usedColsModel = usedColsModel;
        m_dimensionModel = dimensionModel;
    ...
    protected void saveSettingsTo(final NodeSettingsWO settings) throws InvalidSettingsException {
        if (m_dimensionModel.getIntValue() > m_maximumDim) {
            throw new InvalidSettingsException(LDA2.createTooHighDimWarning(m_dimensionModel.getIntValue(),
                m_maximumDim, m_selectedClasses, m_selectedColumns, m_classColComponent.getSelected()));
        }

        if (m_maximumDim <= 0) {
            throw new InvalidSettingsException(
                LDA2.createMaxDimZeroWarning(m_selectedClasses, m_selectedColumns, m_classColComponent.getSelected()));
        }
    ...
    private void updateWarnings() {
        ...
        if (m_maximumDim <= 0) {
            // AP-10106 case 1
            maxDimZeroComponent.setText(wrapText("Warning: " + LDA2.createMaxDimZeroWarning(m_selectedClasses,
            ...
            // AP-10106 case 2
            tooHighDimComponent
                .setText(wrapText("Warning: " + LDA2.createTooHighDimWarning(m_dimensionModel.getIntValue(),
                    m_maximumDim, m_selectedClasses, m_selectedColumns, m_classColComponent.getSelected())));

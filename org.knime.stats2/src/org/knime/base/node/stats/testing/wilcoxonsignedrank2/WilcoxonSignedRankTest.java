...
public class WilcoxonSignedRankTest {
    ...
    private RankStatistics m_rankStatistics = new RankStatistics();
    ...
    /**
     * Adds the rank statistics of this test to the table.
     *
     * @param testNr The number of this test. It will be added to the table in the first column.
     * @param table The table to add to.
     */
    public void addRankStatisticsToTable(final int testNr, final BufferedDataContainer table) {
        m_rankStatistics.addRowsToTable(testNr, table);
    }

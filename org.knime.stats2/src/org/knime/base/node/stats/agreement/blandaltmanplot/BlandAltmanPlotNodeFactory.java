...
public class BlandAltmanPlotNodeFactory extends NodeFactory<BlandAltmanPlotNodeModel>implements
    WizardNodeFactoryExtension<BlandAltmanPlotNodeModel, BlandAltmanPlotViewRepresentation, BlandAltmanPlotViewValue> {

    /**
     * {@inheritDoc}
     */
    @Override
    public BlandAltmanPlotNodeModel createNodeModel() {
        return new BlandAltmanPlotNodeModel();
    }
     ...
     */
    @Override
    public NodeView<BlandAltmanPlotNodeModel> createNodeView(final int viewIndex,
        final BlandAltmanPlotNodeModel nodeModel) {
        return null;
    }
    ...
    protected NodeDialogPane createNodeDialogPane() {
        return new BlandAltmanPlotNodeDialogPane();
    }

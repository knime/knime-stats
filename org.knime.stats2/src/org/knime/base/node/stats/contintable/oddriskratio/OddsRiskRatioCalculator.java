...
public class OddsRiskRatioCalculator {
    ...
    private OddsRiskRatioCalculator() {
    }

    static ContingencyTable calculateOddsRiskRatio(final String columnX, final String columnY, final String valueX,
        final String valueY, final Double lapaceCorrection, final Double confidenceLevel,
        final BufferedDataTable dataTable, final BufferedDataContainer contingencyTableContainer)
        throws InvalidSettingsException {
        Map<String, Map<String, Integer>> counts = BivariateCounts.getCounts(dataTable, columnX, columnY);
        ...
        double lpCorr = 0.0;
        if (a == 0 || b == 0 || c == 0 || d == 0) {
            lpCorr = lapaceCorrection;
        }

        ContingencyTable orr = new ContingencyTable(a, b, c, d, confidenceLevel, lpCorr);

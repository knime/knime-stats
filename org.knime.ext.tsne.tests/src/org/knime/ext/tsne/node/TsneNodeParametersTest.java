...
final class TsneNodeParametersTest extends DefaultNodeSettingsSnapshotTest {
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(TsneNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static TsneNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(TsneNodeParameters.class).getParent().resolve("node_settings")
                .resolve("TsneNodeParameters.xml");
    ...
    private static DataTableSpec createDefaultTestTableSpec() {
        return new DataTableSpec(
            new String[]{"Universe_0_0", "Universe_0_1", "Universe_1_0", "Universe_1_1", "other_column"},
            new DataType[]{
